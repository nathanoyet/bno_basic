/**
 * @file    int_periph_layer.h
 * @brief   ARM Cortex-M4 Internal Peripheral Layer
 * @details This header file contains the public interface for ARM Cortex-M4 internal peripherals 
 *          including register structures, address mappings, and access macros. The implementation 
 *          covers both Cortex-M4 specific peripherals and Armv7-M Architecture registers as defined
 *          in the respective reference manuals.
 * 
 * @note    This interface includes Armv7-M Architecture registers not covered in the Cortex-M4
 *          Generic User Guide but documented in the Armv7-M Architecture Reference Manual.
 */
