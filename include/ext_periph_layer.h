/**
 * @file    ext_periph_layer.h
 * @brief   STM32F411 External Peripheral Layer
 * @details This header file contains the public interface for STM32F411 external peripherals  
 *          including a peripheral interrupt number enumeration, register structures, address
 *          mappings, and access macros.
 */
...
/** @note DBGMCU_BASE - debug MCU registers base address definition */
...
/** @note ADC1_COMMON_BASE is not included in the data sheet memory map but it is included in ST's 
 *        CMSIS STM32F411xE Device Peripheral Access Layer Header File (stm32f411xe.h)
*/
...
/****************************** Bits definition for I2C_CR1 register ******************************/
...
#define I2C_CR1_SMBUS_I2C_MODE          (0x0UL << I2C_CR1_SMBUS_Pos)
#define I2C_CR1_SMBUS_SMBUS_MODE        (0x1UL << I2C_CR1_SMBUS_Pos)

#define I2C_CR1_SMBTYPE_Pos             (3U)
#define I2C_CR1_SMBTYPE_Msk             (0x1UL << I2C_CR1_SMBTYPE_Pos)
#define I2C_CR1_SMBTYPE                 I2C_CR1_SMBTYPE_Msk
#define I2C_CR1_SMBTYPE_DEVICE          (0x0UL << I2C_CR1_SMBTYPE_Pos)
#define I2C_CR1_SMBTYPE_HOST            (0x1UL << I2C_CR1_SMBTYPE_Pos)
...
#define I2C_CR1_POS_CURRENT             (0x0UL << I2C_CR1_POS_Pos)
#define I2C_CR1_POS_NEXT                (0x1UL << I2C_CR1_POS_Pos)

#define I2C_CR1_PEC_Pos                 (12U)
#define I2C_CR1_PEC_Msk                 (0x1UL << I2C_CR1_PEC_Pos)
#define I2C_CR1_PEC                     I2C_CR1_PEC_Msk
#define I2C_CR1_PEC_NO_TRANSFER         (0x0UL << I2C_CR1_PEC_Pos)
#define I2C_CR1_PEC_TRANSFER            (0x1UL << I2C_CR1_PEC_Pos)

#define I2C_CR1_ALERT_Pos               (13U)
#define I2C_CR1_ALERT_Msk               (0x1UL << I2C_CR1_ALERT_Pos)
#define I2C_CR1_ALERT                   I2C_CR1_ALERT_Msk
#define I2C_CR1_ALERT_SMBA_HIGH         (0x0UL << I2C_CR1_ALERT_Pos)
#define I2C_CR1_ALERT_SMBA_LOW          (0x1UL << I2C_CR1_ALERT_Pos)

#define I2C_CR1_SWRST_Pos               (15U)
#define I2C_CR1_SWRST_Msk               (0x1UL << I2C_CR1_SWRST_Pos)
#define I2C_CR1_SWRST                   I2C_CR1_SWRST_Msk
#define I2C_CR1_SWRST_NOT_UNDER_RST     (0x0UL << I2C_CR1_SWRST_Pos)
#define I2C_CR1_SWRST_UNDER_RST         (0x1UL << I2C_CR1_SWRST_Pos)

/****************************** Bits definition for I2C_CR2 register ******************************/
...
/****************************** Bits definition for I2C_OAR2 register *****************************/
...
/******************************* Bits definition for I2C_DR register ******************************/
#define I2C_DR_Pos                      (0U)
#define I2C_DR_Msk                      (0xFFUL << I2C_DR_Pos)
#define I2C_DR                          I2C_DR_Msk

/****************************** Bits definition for I2C_SR1 register ******************************/
#define I2C_SR1_START_BIT_Pos           (0U)
#define I2C_SR1_START_BIT_Msk           (0x1UL << I2C_SR1_START_BIT_Pos)
#define I2C_SR1_START_BIT               I2C_SR1_START_BIT_Msk
...
/****************************** Bits definition for I2C_SR2 register ******************************/
...
#define I2C_SR2_PEC_Msk                 (0x1UL << I2C_SR2_PEC_Pos)
#define I2C_SR2_PEC                     I2C_SR2_PEC_Msk

/****************************** Bits definition for I2C_CCR register ******************************/
...
/****************************** Bits definition for I2C_TRISE register *****************************/
#define I2C_TRISE_Pos                   (0U)
#define I2C_TRISE_Msk                   (0x3FUL << I2C_TRISE_Pos)
#define I2C_TRISE                       I2C_TRISE_Msk

/****************************** Bits definition for I2C_FLTR register *****************************/
