 ...
 * @details This header file contains the public interface for the STM32F411 GPIO driver. It 
 *          includes enumerations, configuration structures and function prototypes for GPIO usage 
 */
